...
for column in ["Employees", "Average_Salary", "Employee_Satisfaction",
               "Training_Hours_Per_Employee", "Annual_Revenue"]:
...
view = df.copy() if not segment else df[df["Customer_Segment"].isin(segment)].copy()
